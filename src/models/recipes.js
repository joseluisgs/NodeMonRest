...
// Devuelve el ID
RecipeSchema.statics.getById = function getById(id) {
...
RecipeSchema.statics.getAll = function getAll(pageOptions, searchOptions) {
...
RecipeSchema.method('toJSON', function toJSON() {
